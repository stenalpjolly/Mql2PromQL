    ...
    <Layout>
      <div className="flex flex-grow overflow-hidden">
        ...
        <div className="flex-grow flex flex-col p-4 sm:p-6 overflow-y-auto">
          ...
          <div className="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
             ...
             <div className="flex gap-3">
                 <button
                   ...
                   className="hidden md:flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 rounded-lg shadow-sm text-slate-700 font-medium hover:bg-slate-50 hover:text-blue-600 transition-colors whitespace-nowrap"
                 >
          ...
          {/* Mode Switcher */}
          <div className="mb-4 bg-slate-100 p-1 rounded-lg inline-flex self-start">
            <button 
            ...
            <button 
                ...
                className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all ${
                    mode === 'batch' ? 'bg-white text-slate-800 shadow-sm' : 'text-slate-500 hover:text-slate-700'
                }`}
            >
                Batch Upload
            </button>
